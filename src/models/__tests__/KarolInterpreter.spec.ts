...
function executeCondition(condition: string, world: WorldModel): boolean {
    ...
    assertCondition(tree.ruleIndex === TypedKarolParser.RULE_conditionexpression, "Internal Error: parse did not return a condition");
