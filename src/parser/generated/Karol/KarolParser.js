...
export default class KarolParser extends antlr4.Parser {
    ...
    static literalNames = [ null, "'programm'", "'endeprogramm'", "'*programm'", 
                            ...
                            "';'", "'karol'", "'.'", "'('", "')'", "'wiederhole'", 
                            "'mal'", "'endewiederhole'", "'*wiederhole'", 
                            "'solange'", "'bis'", "'wenn'", "'dann'", "'sonst'", 
                            "'endewenn'", "'*wenn'", "'schritt'", "'linksdrehen'", 
                            "'rechtsdrehen'", "'hinlegen'", "'aufheben'", 
                            "'markesetzen'", "'markel\u00F6schen'", "'warten'", 
                            "'ton'", "'beenden'", "'schnell'", "'langsam'", 
                            "'nicht'", "'istwand'", "'nichtistwand'", "'ists\u00FCden'", 
                            "'istnorden'", "'istwesten'", "'istosten'", 
                            "'istvoll'", "'nichtistvoll'", "'istleer'", 
                            "'nichtistleer'", "'istziegel'", "'nichtistziegel'", 
                            "'istmarke'", "'nichtistmarke'", "'hatziegel'", 
                            "'wahr'", "'falsch'", "'rot'", "'gelb'", "'blau'", 
                            "'gr\u00FCn'", "'schwarz'" ];
    ...
    static ruleNames = [ "karol", "definition", "methoddefinition", "conditiondefinition", 
                         "statement", "customMethodCall", "iteration", "loop", 
                         "conditional", "instruction", "parameterizedinstruction", 
                         "conditionexpression", "customConditionCall", "condition", 
                         "parameterizedcondition", "color", "number" ];
	...
	karol() {
	    ...
	    try {
	        ...
	        case 1:
	            ...
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            while(((((_la - 14)) & ~0x1f) == 0 && ((1 << (_la - 14)) & ((1 << (KarolParser.T__13 - 14)) | (1 << (KarolParser.T__17 - 14)) | (1 << (KarolParser.T__23 - 14)) | (1 << (KarolParser.T__28 - 14)) | (1 << (KarolParser.T__29 - 14)) | (1 << (KarolParser.T__30 - 14)) | (1 << (KarolParser.T__31 - 14)) | (1 << (KarolParser.T__32 - 14)) | (1 << (KarolParser.T__33 - 14)) | (1 << (KarolParser.T__34 - 14)) | (1 << (KarolParser.T__35 - 14)) | (1 << (KarolParser.T__36 - 14)) | (1 << (KarolParser.T__37 - 14)) | (1 << (KarolParser.T__38 - 14)) | (1 << (KarolParser.T__39 - 14)))) !== 0) || _la===KarolParser.IDENTIFIER) {
	                this.state = 41;
	                this.statement();
	                this.state = 46;
	                this._errHandler.sync(this);
	...
	conditiondefinition() {
	    ...
	    try {
	        ...
	        do {
	            ...
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	        } while(((((_la - 14)) & ~0x1f) == 0 && ((1 << (_la - 14)) & ((1 << (KarolParser.T__13 - 14)) | (1 << (KarolParser.T__17 - 14)) | (1 << (KarolParser.T__23 - 14)) | (1 << (KarolParser.T__28 - 14)) | (1 << (KarolParser.T__29 - 14)) | (1 << (KarolParser.T__30 - 14)) | (1 << (KarolParser.T__31 - 14)) | (1 << (KarolParser.T__32 - 14)) | (1 << (KarolParser.T__33 - 14)) | (1 << (KarolParser.T__34 - 14)) | (1 << (KarolParser.T__35 - 14)) | (1 << (KarolParser.T__36 - 14)) | (1 << (KarolParser.T__37 - 14)) | (1 << (KarolParser.T__38 - 14)) | (1 << (KarolParser.T__39 - 14)) | (1 << (KarolParser.T__40 - 14)) | (1 << (KarolParser.T__41 - 14)) | (1 << (KarolParser.T__42 - 14)) | (1 << (KarolParser.T__43 - 14)) | (1 << (KarolParser.T__44 - 14)))) !== 0) || ((((_la - 46)) & ~0x1f) == 0 && ((1 << (_la - 46)) & ((1 << (KarolParser.T__45 - 46)) | (1 << (KarolParser.T__46 - 46)) | (1 << (KarolParser.T__47 - 46)) | (1 << (KarolParser.T__48 - 46)) | (1 << (KarolParser.T__49 - 46)) | (1 << (KarolParser.T__50 - 46)) | (1 << (KarolParser.T__51 - 46)) | (1 << (KarolParser.T__52 - 46)) | (1 << (KarolParser.T__53 - 46)) | (1 << (KarolParser.T__54 - 46)) | (1 << (KarolParser.T__55 - 46)) | (1 << (KarolParser.T__56 - 46)) | (1 << (KarolParser.T__57 - 46)) | (1 << (KarolParser.IDENTIFIER - 46)))) !== 0));
	        this.state = 94;
	        _la = this._input.LA(1);
	...
	instruction() {
	    ...
	    try {
	        ...
	        this.state = 190;
	        _la = this._input.LA(1);
	        if(!(((((_la - 29)) & ~0x1f) == 0 && ((1 << (_la - 29)) & ((1 << (KarolParser.T__28 - 29)) | (1 << (KarolParser.T__29 - 29)) | (1 << (KarolParser.T__30 - 29)) | (1 << (KarolParser.T__31 - 29)) | (1 << (KarolParser.T__32 - 29)) | (1 << (KarolParser.T__33 - 29)) | (1 << (KarolParser.T__34 - 29)) | (1 << (KarolParser.T__35 - 29)) | (1 << (KarolParser.T__36 - 29)) | (1 << (KarolParser.T__37 - 29)) | (1 << (KarolParser.T__38 - 29)) | (1 << (KarolParser.T__39 - 29)))) !== 0))) {
	        this._errHandler.recoverInline(this);
	        }
	        else {
	        	this._errHandler.reportMatch(this);
	...
	condition() {
	    ...
	    try {
	        ...
	        this.state = 240;
	        _la = this._input.LA(1);
	        if(!(((((_la - 42)) & ~0x1f) == 0 && ((1 << (_la - 42)) & ((1 << (KarolParser.T__41 - 42)) | (1 << (KarolParser.T__42 - 42)) | (1 << (KarolParser.T__43 - 42)) | (1 << (KarolParser.T__44 - 42)) | (1 << (KarolParser.T__45 - 42)) | (1 << (KarolParser.T__46 - 42)) | (1 << (KarolParser.T__47 - 42)) | (1 << (KarolParser.T__48 - 42)) | (1 << (KarolParser.T__49 - 42)) | (1 << (KarolParser.T__50 - 42)) | (1 << (KarolParser.T__51 - 42)) | (1 << (KarolParser.T__52 - 42)) | (1 << (KarolParser.T__53 - 42)) | (1 << (KarolParser.T__54 - 42)) | (1 << (KarolParser.T__55 - 42)) | (1 << (KarolParser.T__56 - 42)) | (1 << (KarolParser.T__57 - 42)))) !== 0))) {
	        this._errHandler.recoverInline(this);
	        }
	        else {
	        	this._errHandler.reportMatch(this);
	...
	color() {
	    ...
	    try {
	        ...
	        this.state = 275;
	        _la = this._input.LA(1);
	        if(!(((((_la - 59)) & ~0x1f) == 0 && ((1 << (_la - 59)) & ((1 << (KarolParser.T__58 - 59)) | (1 << (KarolParser.T__59 - 59)) | (1 << (KarolParser.T__60 - 59)) | (1 << (KarolParser.T__61 - 59)) | (1 << (KarolParser.T__62 - 59)))) !== 0))) {
	        this._errHandler.recoverInline(this);
	        }
	        else {
	        	this._errHandler.reportMatch(this);
...
KarolParser.T__61 = 62;
KarolParser.T__62 = 63;
KarolParser.IDENTIFIER = 64;
KarolParser.LETTER = 65;
KarolParser.DIGIT = 66;
KarolParser.WS = 67;
...
class ConditiondefinitionContext extends antlr4.ParserRuleContext {
	...
	conditionexpression = function(i) {
	    if(i===undefined) {
	        i = null;
	    }
	    if(i===null) {
	        return this.getTypedRuleContexts(ConditionexpressionContext);
	    } else {
	        return this.getTypedRuleContext(ConditionexpressionContext,i);
	    }
	};
