...
import {GizmoHelper, GizmoViewcube, Line, Sky} from "@react-three/drei";
...
function World3DInternal(props: { model: WorldModel }): ReactElement<typeof props> {
    return <Canvas shadows={true} gl={{alpha: true}} camera={{fov: 60, position: [-10, 0, -10]}}>
        <Sky sunPosition={[100, 20, 100]}/>
        <ambientLight intensity={0.3}/>
        <pointLight castShadow intensity={0.8} position={[100, 100, 100]}/>
        <DashedLine from={[0, 0, 0]} to={[10, 0, 0]} color="red"/>
        <DashedLine from={[0, 0, 0]} to={[0, 10, 0]} color="blue"/>
        {/*<Plane args={[10, 10]} position={[0, -7, 7]} rotation={[1.5, 0, 0]}>*/}
        {/*    <meshPhongMaterial attach="material" color="#f3f3f3" wireframe/>*/}
        {/*</Plane>*/}
        {/*<Plane args={[10, 10]} position={[0, 0, 0]} rotation={[0, 360, 0]}>*/}
        {/*    <meshPhongMaterial attach="material" color="#f3f3f3" wireframe/>*/}
        {/*</Plane>*/}
        {
